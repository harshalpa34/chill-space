...
const ChatItem = ({
  ...
  console.log({ isOwner, canDeleteMessage });
        ...
        <div className="flex flex-col w-full">
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
              ...
              <span className="text-[10px] mt-1 text-zinc-499">
        ...
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 top-2 right-5 bg-zinc-800 border rounded-sm">
          {canEditMessage && (
            <ActionTooltip label="Edit">
              <EditIcon
                className="h-4 w-4 cursor-pointer ml-auto text-zinc-500 hover:text-zinc-300"
          ...
          <ActionTooltip label="Delete">
            <TrashIcon
              className="h-4 w-4 cursor-pointer  text-zinc-500 hover:text-zinc-300"
              onClick={() =>
